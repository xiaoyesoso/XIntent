# Agent 听不懂人话？我用了 31 个设计决策来解决这个问题
...
**准确率提升**（设计决策 17-25，后文简写为 D17-D25），回答的是，怎么把准确率从 85% 推到 99%？八个可选扩展，每个针对一类特定失败模式。

> 这里说明一下，文中的 D1、D2...D31 是我们在设计过程中给每个决策编的号，D 就是 Design Decision 的缩写。方便你在代码和文档之间互相对照。
